...
QT_MOC_LITERAL(1, 7, 14), // "spriteSelected"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 7), // "Sprite*"
QT_MOC_LITERAL(4, 31, 6), // "sprite"
QT_MOC_LITERAL(5, 38, 21), // "currentCostumeChanged"
QT_MOC_LITERAL(6, 60, 17), // "setCurrentCostume"
QT_MOC_LITERAL(7, 78, 8), // "Costume*"
QT_MOC_LITERAL(8, 87, 7) // "costume"

    },
    "Sprite\0spriteSelected\0\0Sprite*\0sprite\0"
    "currentCostumeChanged\0setCurrentCostume\0"
    "Costume*\0costume"
};
...
void Sprite::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->spriteSelected((*reinterpret_cast< Sprite*(*)>(_a[1]))); break;
        case 1: _t->currentCostumeChanged((*reinterpret_cast< Sprite*(*)>(_a[1]))); break;
        case 2: _t->setCurrentCostume((*reinterpret_cast< Costume*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Sprite::*_t)(Sprite * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Sprite::spriteSelected)) {
                *result = 0;
            }
        }
        {
            typedef void (Sprite::*_t)(Sprite * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Sprite::currentCostumeChanged)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Sprite::spriteSelected(Sprite * _t1)
{
...
// SIGNAL 1
void Sprite::currentCostumeChanged(Sprite * _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
